...
passport.use(new GoogleStrategy({
    ...
    callbackURL: "http://uas.sekai.id:3000/api/auth/google/callback",
...
passport.use(new FacebookStrategy({
    ...
    callbackURL: "http://uas.sekai.id:3000/api/auth/facebook/callback",
...
passport.use(new TwitterStrategy({
    ...
    callbackURL: "http://uas.sekai.id:3000/api/auth/twitter/callback",
    includeEmail: true,
    passReqToCallback: true
  },
