...
export default function PaymentDetail() {
  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB] font-jakarta pb-32">
      {/* Main Container */}
      ...
      <div className="bg-white rounded-xl shadow mb-28">
        ...
        {/* Bottom Action Bar */}
        <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 py-3 shadow-top-md">
